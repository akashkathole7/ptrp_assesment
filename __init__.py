...
class akashian:
    def __init__(self,conditional_probabillity,fixed_probability_head_and_tails,
                 frequency_occurance,normal_dist,binomail_probability_distribution,
                 poission_distribution,pearson_correlation_distribution,checking_average
                 ,calculate_t_test_for_2_independant,correlation_coefficent):
        self.conditional_probabillity = conditional_probabillity
        self.fixed_probability_head_and_tails = fixed_probability_head_and_tails
        self.frequency_occurance = frequency_occurance
        self.normal_dist = normal_dist
        self.binomail_probability_distribution = binomail_probability_distribution
        self.poission_distribution = poission_distribution
        self.pearson_correlation_distribution = pearson_correlation_distribution
        self.simple_linear_regression = simple_linear_regression
        self.checking_average = checking_average
        self.calculate_t_test_for_2_independant = calculate_t_test_for_2_independant
        self.correlation_coefficent = correlation_coefficent


    def conditional_probabillity(self,a, b):
        import random
        a = [0, 1]
        b = [0, 1]
        atleast = 0
    ...
    # head = 0
    # tail = 0
    def fixed_probability_head_and_tails(self,li,head,tail):
        import random
        head = 0
        tail = 0
        ...
        # li = [1, 2, 3, 4, 5, 6]
    def frequency_occurance(self,li):
        import random
        li = [1, 2, 3, 4, 5, 6]
        die1 = 0
   ...
   def simple_linear_regression(self,X, Y, n):
        sum_X = 0
        sum_Y = 0
        sum_XY = 0
        squareSum_X = 0
   ...
   def calculate_t_test_for_2_independant(self,data1,data2,alpha):
   ...
   def correlation_coefficent(self,x, y, n):
        """ import pandas as pd
        import scipy.stats
        import math
        x = [15, 18, 21, 15, 21]
